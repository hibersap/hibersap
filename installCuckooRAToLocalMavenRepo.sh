...
mvn install:install-file -Dfile=$1 -DgroupId=org.hibersap -DartifactId=com.sap.conn.jco.sapjco3 -Dversion=$2 -Dclassifier=$3 -Dpackaging=$FILE_EXT -DlocalRepositoryPath=~/.localrepo/
