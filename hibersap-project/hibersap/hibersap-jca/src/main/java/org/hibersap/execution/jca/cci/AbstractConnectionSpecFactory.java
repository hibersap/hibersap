    ...
    implements ConnectionSpecFactory
{
        ...
        throws InternalHiberSapException
    {
        ...
        {
            throw new InternalHiberSapException( "Can not access declared constructor: "
        ...
        {
            throw new InternalHiberSapException( "Cannot create new instance of: "
                + getSignature( connectionSpecClass, constructorParameterTypes ), e );
        }
        ...
        {
            throw new InternalHiberSapException( "Constructor threw an Exception: "
                + getSignature( connectionSpecClass, constructorParameterTypes ), e );
        }
