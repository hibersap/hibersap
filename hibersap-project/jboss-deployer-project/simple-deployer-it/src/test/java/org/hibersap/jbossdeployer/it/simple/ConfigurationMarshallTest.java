...
public class ConfigurationMarshallTest
{
    ...
    {
        jaxbContext = JAXBContext.newInstance( HiberSapMetaData.class, SessionFactoryMetaData.class, Property.class );
    }
        ...
        throws Exception
    {
        ...
        final SessionFactoryMetaData sessionFactory = hiberSapMetaData.getSessionFactory();
        ...
        throws Exception
    {
        ...
        final SessionFactoryMetaData sessionFactoryMetaData = new SessionFactoryMetaData( "session-name",
        ...
        final HiberSapMetaData hiberSapMetaData = new HiberSapMetaData( sessionFactoryMetaData );
