...
public class HiberSapMetaData {
	...
	public HiberSapMetaData(final SessionFactoryMetaData sessionFactory) {
		this.sessionFactory = sessionFactory;
	}

	public void setSessionFactory(final SessionFactoryMetaData sessionFactory) {
		this.sessionFactory = sessionFactory;
	}

	@XmlElement(name = "session-factory", required = true, namespace = HiberSapMetaData.NAMESPACE)
