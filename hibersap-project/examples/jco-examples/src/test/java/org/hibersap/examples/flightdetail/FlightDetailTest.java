...
public class FlightDetailTest extends AbstractHibersapTest
{
    ...
    public void testShowFlightDetail()
    {
        ...
        try
        {
            ...
            final Date flightDate = new GregorianCalendar( 2011, Calendar.NOVEMBER, 15 ).getTime();
            final FlightDetailBapi flightDetail = new FlightDetailBapi( "AZ", "0788", flightDate );
